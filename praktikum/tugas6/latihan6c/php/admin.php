                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="search-form">
                                <form class="form-inline form-row" action="" method="get">
                                    <input class="form-control mr-sm-2 col-9" type="search" placeholder="Search" aria-label="Search" name="keyword" autofocus>
                        ...
                        <div class="col-md-2">
                            <div class="logout float-right">
                                <a href="logout.php" class="btn btn-sm btn-danger logout-link">Logout</a>
                            </div>
                        </div>
                    </div>
