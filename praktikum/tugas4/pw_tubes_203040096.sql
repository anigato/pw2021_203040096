...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2021 at 02:54 AM
...
(1, '43ate5rg', 'SSD Sandisk 120GB SATA3', 'SSD', 'SANDISK', 76, 120, 400000, 123, 'sandisk1.png', 'SSd sandisk 120gb sata3, dengan kecepatan baca upto 500MB/s dan kecepatan tulis upto 400MB/s'),
(2, '4y5w', 'SSD adata 120GB SATA3', 'SSD', 'ADATA', 15, 120, 300000, 345, 'ssd-adata.png', 'SSd adata 120gb sata3'),
(3, '54y5rft', 'SSD adata xpg 512gb', 'SSD NVME', 'ADATA', 98, 512, 1500000, 400, 'ssd-adata-xpg.png', '<div>SSD Adata XPG SX8200 PRO 1TB M.2 NVME PCIE<br><br>Solid State Disk atau yang lazim kita kenal dengan SSD saat ini begitu popular di kalangan pengguna Laptop dan PC. Hal itu dikarenakan SSD memiliki banyak Kelebihan jika dibandingkan dengan Hardisk atau HDD.<br><br>SX8200 M.2 2280 merupakan tipe SSD internal dari ADATA yang menggunakan interface PCIe Gen3x4 yang sangat cepat, dan memiliki kecepatan Read / Write yang sangat tinggi hingga 3500 / 3000 MB per detik. Serta dengan teknologi 3D NAND Flash yang memberikan kinerja lebih tinggi, ketahanan dan efisiensi daya yang tinggi.<br><br>SSD Pci express ini sangat cocok buat Gamers, PC overclok, atau membuat Video dan kebutuhan aplikasi tinggi.<br><br>SX8200 Pro memenuhi persyaratan NVMe 1.2 dan NVMe 1.3 Support dan menghadirkan kemampuan baca / tulis superior random dan kemampuan multi-tasking. Sangat rekomendasi buat Intel dan AMD yang terbaru.<br><br>Spesifikasi SSD Adata XPG SX8200 PRO 1TB M.2 NVME PCIE :<br>- Tipe : SX8200 SSD M.2 Pcie Gen3x4 - Kapasitas : 1TB<br>- Form Factor : M.2 2280<br>- NAND Flash : 3D TLC<br>- Controller : SMI<br>- Interface : PCIe Gen3x4<br>- Performace : Baca 3500MB/s ; Tulis 3000MB/s<br>- MTBF : 2.000.000 Jam<br><br>Garansi Resmi 5 Tahun<br><br>Perhatian!!<br>- Semua Tempat Penyimpanan data hanya memiliki Kapasitas Real 90% - 93% dari Kapasitas yang tertera.<br>- Sebelum melakukan pemesanan harap menyakan ketersediaan stok terlebih dahulu.<br>- Selamat Berbelanja dan Terimakasih..&nbsp;<br><br></div><div><br><br></div>'),
(4, 'r5tyhbdf', 'SSD apacer 240gb SATA3', 'SSD', 'APACER', 68, 240, 600000, 600, 'ssd-apacer.png', 'SSd apacer 240gb sata3'),
(5, 'wesf43a', 'SSD kingmax 256gb SATA3', 'SSD', 'KINGMAX', 45, 256, 650000, 340, 'ssd-kingmax.png', 'SSd kingmax 256gb sata3'),
(6, '45yrd3', 'SSD pioneer 120GB SATA3', 'SSD', 'PIONEER', 23, 120, 400000, 560, 'ssd-pioneer.png', 'SSd pioneer 120gb sata3'),
(7, '54erdg43e', 'SSD samsung 1tb SATA3', 'SSD', 'SAMSUNG', 45, 1, 2300000, 900, 'ssd-samsung.png', 'SSd samsung 1tb sata3'),
(8, 'thdr56hffs', 'SSD vgen 240gb SATA3', 'SSD', 'V-GEN', 69, 240, 600000, 340, 'ssd-vgen.png', 'SSd vgen 240gb sata3'),
(9, 'hdtrd45e', 'SSD vgen nvme 256gb SATA3', 'SSD NVME', 'V-GEN', 89, 256, 870000, 550, 'ssd-vgen-nvme.png', 'SSd vgen nvme 256gb sata3'),
(10, 'thdr5gnf', 'SSD wd green 120GB SATA3', 'SSD', 'WD', 99, 120, 350000, 698, 'ssd-wd-green.png', 'SSD wd green 120GB SATA3');
